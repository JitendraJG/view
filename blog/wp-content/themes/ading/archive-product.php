 ...
 */
	...
	$sidebar_type = seocrawler_get_option('general', 'woocommerce-archive-sidebar', 'none');
	$sidebar_left = seocrawler_get_option('general', 'woocommerce-archive-sidebar-left');
	$sidebar_right = seocrawler_get_option('general', 'woocommerce-archive-sidebar-right');		
