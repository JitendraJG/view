...
class Ideazoneall extends CI_Controller{
	...
	function index(){
		...
		$config = array();
			$config["base_url"] = base_url() . "/ideazoneall/page/";
			...
			$data['PostedIdeas'] = $this->Post_model->getIdeasPostedPagenation($session_user,$config["per_page"], $page);
	...
	function page(){
		...
		$config = array();
			...
			$data['savedideas'] = $this->Post_model->idea_check_savedcount($session_user,$saved);
			$data['industry'] = $this->Post_model->getindustry();
			$data['bussinessIdeasall'] = $this->User_model->getbussinessIdeasPage($session_user, $config["per_page"], $page);
			$data['bussinessIdeasall'] = $this->User_model->bussinessIdeasall();
			$data['SavedIdeasb'] = $this->User_model->getbussinessIdeassaved($session_user);
			$data['PostedIdeas'] = $this->Post_model->getIdeasPostedPagenation($session_user,$config["per_page"], $page);
			$data['InitiatedIdeas'] = $this->Post_model->getIdeasInitia($session_user);
