	...
	<section class="ideazone">
		<div class="container">
			<div class="row mb-20">
				...
				<div class="col-md-6 text-right search-skill">
					<form id="demo-2">
						<input type="search" placeholder="Search" class="cont-search pr-4">
					</form>
				</div>
			</div>
			<div class="row">
					...
					<div class="filter-content grey-block mb-20">
						...
						<form>
							...
							<select class="form-control">
								...
								<option value="">Shortlists</option>
							...
							<div class="md-checkbox md-checkbox-inline">
								...
								<label for="i1">Entreprenuer</label>
							</div>
							<div class="md-checkbox md-checkbox-inline">
								<input id="i2" type="checkbox">
								<label for="i2">Invester</label>
							</div>
