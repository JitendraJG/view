		...
		<div class="container">
			<div class="row mb-20">
				...
				<div class="col-md-6 text-right">
					<a href="<?php echo base_url('offer-a-franchize'); ?>"><button class="btn btn-info mb-0 mblock-btn">Offer a Franchize</button></a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
						...
						<div class="content p-lr-5">
							<div class="row">
								<div class="col-md-6">
									...
									<h6>Location</h6>
									<p>Hyderabad</p>
                                    <h6>Franchize Model</h6>
									<p>FM001</p>
									<h6>Approx Investiment</h6>
                                    <ul class="inline-list p-0">
                                      <li class="clearfix">INR.200000 - INR.500000</li>
                                    </ul>
                                    <h6>Approx Income</h6>
                                    <ul class="inline-list p-0">
                                      <li class="clearfix">INR. 10 l/a</li>
                                    </ul>
