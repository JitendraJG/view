	...
	<section class="ideazone">
		<div class="container">
			<div class="row mb-20">
				<div class="col-md-6">
					<h4 class="mt-0 mb-0">Franchize Offers</h4>
				</div>
				<div class="col-md-6 text-right">
					<button class="btn btn-info mb-0 mblock-btn">Offer a Franchize</button>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					...
					<div class="ideazone-content">
						<div class="row">
							<div class="col-sm-6 col-md-4">
								<div class="profile-box pointer" onclick="location.href='#';">
									<div class="p10">
									<div class="mb-10">
									...
									<div>
										<button class="btn" data-toggle="modal" data-target="#signin">View Contact</button>
										<button class="btn" data-toggle="modal" data-target="#signin">Shortlist</button>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-md-4">
