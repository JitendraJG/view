								...
								<div class="col-md-6">
									...
									<div class="grey-block mb-20">
										...
										<ul class="inline-list p-0">
										  <li>UI Designing, 3+ Exp</li>
										  <li>UI Developer, 5+ Exp</li>
										</ul>
                                        <p class="mb-0 mt-20"><b>Investor:</b></p>
                                        <ul class="inline-list p-0">
										  <li class="clearfix">Investment Expected: Rs.200000 - Rs.500000</li>
										  <li class="clearfix">Share Offered: 30% - 40%</li>
										  <li class="clearfix">Expected Role: UI Designer</li>
										</ul>
