			...
			<div class="row mb-20">
				<div class="col-md-6">
					<ol class="breadcrumb hidden-xs hidden-sm">
					  ...
					  <li class="breadcrumb-item"><a href="#">Initiated</a></li>
					  <li class="breadcrumb-item active">Required Skills - UI Design - All Profiles</li>
					</ol>
				</div>
				...
				<div class="col-md-3">
					...
					<div class="grey-block filter-content mb-20">
						...
						<form>
							...
							<label>Trust Factor</label>
							<!--<span class="stars stars-md" data-rating="3" data-num-stars="5"></span>-->
