		...
		<div class="container">
			<div class="row mb-20">
				...
				<div class="col-md-6 text-right">
					<button class="btn btn-info mb-0 mblock-btn">Funding Request</button>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="ideazone-content form-box">						
						<div class="content">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label input-box">
								...
								<label class="mdl-textfield__label" for="txarea1">Project Description <sup class="red">*</sup></label>
							</div>
							<label>Current Status <sup class="red">*</sup></label>
							<select class="form-control mb-10">
								<option>Idea Stage</option>
								<option>Go to Market Stage</option>
							...
							<select class="form-control mb-10">
								<option>As a Sleeping Partner</option>
								<option>As a Strategic Partner</option>
								<option>As a Co-Founder</option>
								<option>As a Financiar</option>
								<option>As a Mentor</option>
								<option>Other</option>
							</select>
							
							<button class="btn btn-primary sub pull-right sumbit-btn">Done</button>
