<?php $this->view('admin/user-header') ?>
	<section class="ideazone">
		<div class="container">
			<div class="row mb-20">
				<div class="col-md-6">
					<h4 class="mt-0 mb-0">Offer a Franchize</h4>
				</div>
				...
				<div class="col-md-12">
					<div class="ideazone-content form-box">						
						<div class="content">
							...
							<label class="mt-20">Franchize Model <sup class="red">*</sup></label>
							<select class="form-control mb-10">
								<option>FM001</option>
								<option>FM002</option>
								<option>FM003</option>
							</select>							
							<label class="mt-20">Approx Investiment <sup class="red">*</sup></label>
