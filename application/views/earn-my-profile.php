			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
					...
					<div class="tooltip-box">
						<h3>Proffessional form coins</h3>
						<div class="tt-inner">
							<div class="tt-left">
...
<div class="row">
<div class="top-btn">
<a class="active" href="#">Create Professinal Profile</a>
<a href="<?php echo base_url(); ?>Earn/Myhobby">Create Hobby Profile</a>
</div>
<!-- Accordions -->
<div class="content">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label input-box">
		...
		<label class="lsample" for="sample3">Primary Skills</label>
			<select id="professional" name="professional"  class="mb-10" style="width: 100%;margin-bottom: 10px !important;" placeholder="Primary skill">
...
<div class="grey-form-box">
	...
	<button id="addday" class="btn btn-primary small">Update</button>
...
<select class="form-control medium" name="day" id="day">
	...
	<button id="addday" type="button" class="btn btn-primary small">Add</button>
...
$('#select-country').selectize();
    ...
    <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-2">
      ...
      <span class="mdl-radio__label">Non-Negotiable</span>
			...
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label input-box">
			<input name="competitive" class="mdl-textfield__input" type="text" id="sample3">
			...
			<div id="selectedFiles"></div>
					...
					<button id="ssigninModal" type="button" class="btn btn-primary active" data-toggle="modal" data-target="#signinModal">Submit</button>
...
$("#addday").click(function(){
	var userses="<?php echo $this->session->userdata('user');?>";
	if( !userses ) {
...
$.ajax({
    ...
    success: function(JSONObject) {
		if(JSONObject == 1){
			 window.location.replace("<?php echo base_url('Earn/Profile'); ?>");
		}
      var peopleHTML = "";
      ...
      for (var key in JSONObject) {
        if (JSONObject.hasOwnProperty(key)) {
          peopleHTML += "<div class='dayslist'>";
            ...
            peopleHTML += "<div class='edit'>" + "<a style='color: green;' href='<?php echo base_url('Earn/Profile'); ?>?day="+ JSONObject[key]["day"] +"&from="+ JSONObject[key]["from_time"] +"&to="+JSONObject[key]["to_time"]+"&id="+ JSONObject[key]["id"] +"' class='editc'>Edit</a>" + "</div>";
