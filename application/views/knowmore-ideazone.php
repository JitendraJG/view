...
<link rel="shortcut icon" sizes="196x196" href="icon-196.png">
		...
		<meta name="description" content="If you have a start-up idea or a business Idea, however small, that can make money, then that idea is worth a shot! Create an account & explore at Viewham!">
		...
		<meta name="author" content="">
                <meta name="p:domain_verify" content="1d4e151332c34793d67f9c4696c8548b" />
		<title> Idea Sharing Website | Submit Your StartUp Ideas Online - Viewham </title>
	...
	<section class="knowmore-box"> 
		<div class="container">
			<div class="col-md-12 grey-box">
				<div class="col-md-3 col-sm-6 col-xs-12 pd-0">
					<div class="box">
					...
					<div class="">
						<div class="col-md-12 grey-box">
								...
								therefore we are inclined to provide you with the best opportunity there is for you, to transform your idea into a reality.
									...
									<p>
<ul class="ul-list"><li>	Small investment for small time business ideas
			...
			<section class="knowmore-box"> 
				...
				<section class="knowmore-box"> 
						<div class="container">
							<div class="">
								<div class="col-md-12  btn-sec btn-box text-center">
...
<style>	
.ul-list{margin-left: 25px;font-size: 16px;line-height: 22px;}
</style>	