! function(e) {
        ...
        _initEvents: function() {
            ...
            e.events = {
                ...
                starClick: function(t) {
					...
					console.log(this.cache.val);
				
					 $(".star_"+this.imid).attr("ideaimp",this.imid);
					 $(".star_"+this.imid).addClass("introimpress");
					 var impressid=this.imid;
					 var impress=this.cache.val;
					 var base_url = window.location.origin;
					 var url = base_url+"/Ideazone/ImpressIdea";
    ...
    $.ajax({
           ...
           {
               console.log(data);
			   $('.allstars_'+impressid).attr('data-rating', data);
			  $('.label-default').text("");
		 ...
		 $('.introimpress').click();
				$(".star_"+this.imid).removeClass("introimpress");	
                },
